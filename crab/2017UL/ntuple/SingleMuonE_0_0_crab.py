...
config.General.requestName = 'SingleMuonE_2017E_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=99999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal', 'weight=6.47E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
