...
config.General.requestName = 'TTZHTo4b_TuneCP5_13TeV-madgraph-pythia8_2017_ntuple_0_0_3'
...
config.JobType.pyCfgParams = ['isData=FALSE','maxEvents=999999999','outName=ntuples', 'dataEra=2017','systematicVariations=nominal','weight=2.68E-08','ProduceMemNtuples=False', 'deterministicSeeds=False']
