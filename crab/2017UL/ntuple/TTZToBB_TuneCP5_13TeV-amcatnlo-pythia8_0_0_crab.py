...
config.General.requestName = 'TTZToBB_TuneCP5_13TeV-amcatnlo-pythia8_2017_ntuple_0_0_3'
...
config.JobType.pyCfgParams = ['isData=FALSE','maxEvents=999999999','outName=ntuples', 'dataEra=2017','systematicVariations=nominal','weight=0.000163681','ProduceMemNtuples=False', 'deterministicSeeds=False']
