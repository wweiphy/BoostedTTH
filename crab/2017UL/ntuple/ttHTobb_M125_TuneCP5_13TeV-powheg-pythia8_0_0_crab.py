...
config.General.requestName = 'ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8_2017_ntuple_0_0_3'
...
config.JobType.pyCfgParams = ['isData=FALSE','maxEvents=999999999','outName=ntuples', 'dataEra=2017','systematicVariations=nominal','weight=7.53E-05','ProduceMemNtuples=False', 'deterministicSeeds=False']
