...
config.General.requestName = 'TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8_2017_ntuple_0_0_3'
...
config.JobType.pyCfgParams = ['isData=FALSE','maxEvents=999999999','outName=ntuples', 'dataEra=2017','systematicVariations=nominal','weight=1.50E-06','ProduceMemNtuples=False', 'deterministicSeeds=False']
