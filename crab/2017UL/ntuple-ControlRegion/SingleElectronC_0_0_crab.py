...
config.General.requestName = 'SingleElectronC_2017C_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal','weight=7.32E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
