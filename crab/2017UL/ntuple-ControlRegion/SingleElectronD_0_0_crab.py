...
config.General.requestName = 'SingleElectronD_2017D_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal','weight=1.94E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
