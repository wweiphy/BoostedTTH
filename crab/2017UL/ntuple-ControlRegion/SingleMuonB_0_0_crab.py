...
config.General.requestName = 'SingleMuonB_2017B_ntuple_0_0_2'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal', 'weight=7.34E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
