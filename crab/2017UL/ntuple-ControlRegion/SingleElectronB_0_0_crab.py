...
config.General.requestName = 'SingleElectronB_2017B_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal','weight=1.65E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
