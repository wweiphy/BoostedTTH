...
config.General.requestName = 'SingleMuonD_2017D_ntuple_0_0_2'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal', 'weight=1.42E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
