...
config.General.requestName = 'SingleMuonG_2017G_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal', 'weight=1.22E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
