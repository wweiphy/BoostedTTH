...
config.General.requestName = 'SingleMuonF_2017F_ntuple_0_0_2'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal', 'weight=4.13E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
