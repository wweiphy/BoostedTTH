...
config.General.requestName = 'SingleElectronF_2017F_ntuple_0_0_2'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal','weight=7.78E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
