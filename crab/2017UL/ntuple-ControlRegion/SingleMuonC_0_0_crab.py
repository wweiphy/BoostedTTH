...
config.General.requestName = 'SingleMuonC_2017_ntuple_0_0_2'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal', 'weight=6.04E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
