...
config.General.requestName = 'SingleElectronE_2017E_ntuple_0_0_2'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2017', 'systematicVariations=nominal','weight=9.79E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
