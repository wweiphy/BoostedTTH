...
config.General.requestName = 'SingleElectronC_2018C_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2018', 'systematicVariations=nominal','weight=6.76E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']

# config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2018C', 'systematicVariations=nominal,JES,JER,JESFlavorQCD,JESRelativeBal,JESHF,JESBBEC1,JESEC2,JESAbsolute,JESBBEC1year,JESRelativeSampleyear,JESEC2year,JESHFyear,JESAbsoluteyear', 'weight=6.76E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
...
# config.Data.unitsPerJob = 1000
config.Data.splitting = 'EventAwaLumiBased'
...
# config.Site.blacklist = ['T2_CH_CERN',
                        #  'T2_US_Wisconsin', 'T2_US_Purdue', 'T2_US_Nebraska']
