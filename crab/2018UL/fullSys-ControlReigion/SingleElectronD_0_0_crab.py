...
# config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2018D', 'systematicVariations=nominal,JES,JER,JESFlavorQCD,JESRelativeBal,JESHF,JESBBEC1,JESEC2,JESAbsolute,JESBBEC1year,JESRelativeSampleyear,JESEC2year,JESHFyear,JESAbsoluteyear', 'weight=1.33E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2018D', 'systematicVariations=nominal', 'weight=1.33E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
