...
config.General.requestName = 'SingleMuonA_2018A_ntuple_0_0_3'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=99999999999', 'outName=ntuples', 'dataEra=2018', 'systematicVariations=nominal', 'weight=4.14E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
