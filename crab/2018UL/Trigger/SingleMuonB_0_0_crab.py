...
config.General.requestName = 'SingleMuonB_2018B_ntuple_0_0_3'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=99999999999', 'outName=ntuples', 'dataEra=2018', 'systematicVariations=nominal', 'weight=8.34E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
