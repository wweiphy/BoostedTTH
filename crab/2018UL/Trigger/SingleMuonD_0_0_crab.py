...
config.General.requestName = 'SingleMuonD_2018D_ntuple_0_0_Trigger_2'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=99999999999', 'outName=ntuples', 'dataEra=2018', 'systematicVariations=nominal', 'weight=1.95E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
