...
config.General.requestName = 'TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_2018_ntuple_0_0_4'
...
config.JobType.pyCfgParams = ['isData=FALSE', 'maxEvents=99999999', 'outName=ntuples', 'dataEra=2018',
                              'systematicVariations=nominal,JES,JER', 'weight=7.60E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
