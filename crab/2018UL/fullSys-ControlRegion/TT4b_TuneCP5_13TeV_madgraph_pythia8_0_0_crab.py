...
config.General.requestName = 'TT4b_TuneCP5_13TeV_madgraph_pythia8_2018_ntuple_0_0_5'
...
config.JobType.pyCfgParams = ['isData=FALSE','maxEvents=999999999','outName=ntuples', 'dataEra=2018','systematicVariations=nominal','weight=3.01E-05','ProduceMemNtuples=False', 'deterministicSeeds=False']
