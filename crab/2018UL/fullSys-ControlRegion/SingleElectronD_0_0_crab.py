...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2018', 'systematicVariations=nominal', 'weight=1.33E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
