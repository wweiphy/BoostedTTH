...
config.General.requestName = 'ttHTobb_ttTo2L2Nu_M125_TuneCP5_13TeV-powheg-pythia8_2018_ntuple_0_0_7'
...
config.JobType.pyCfgParams = ['isData=FALSE', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2018',
                              'systematicVariations=nominal', 'weight=5.82E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
