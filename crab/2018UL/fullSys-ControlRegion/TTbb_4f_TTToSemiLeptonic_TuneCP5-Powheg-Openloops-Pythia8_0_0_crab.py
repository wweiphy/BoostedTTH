...
config.General.requestName = 'TTbb_4f_TTToSemiLeptonic_TuneCP5-Powheg-Openloops-Pythia8_2018_ntuple_0_0_7'
...
config.JobType.pyCfgParams = ['isData=FALSE', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2018',
                              'systematicVariations=nominal', 'weight=1.08E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
