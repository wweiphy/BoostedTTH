...
config.General.requestName = 'SingleElectronH_2016H_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016', 'systematicVariations=nominal','weight=7.75E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
