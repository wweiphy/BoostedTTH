...
config.General.requestName = 'SingleMuonH_2016H_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2016', 'systematicVariations=nominal', 'weight=5.75E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
