...
config.General.requestName = 'SingleElectronF_2016F_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016postVFP',
                              'systematicVariations=nominal', 'weight=1.13E-04', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
...
config.Data.outLFNDirBase = '/store/group/lpctthrun2/wwei/UL/2016/ntuple'
