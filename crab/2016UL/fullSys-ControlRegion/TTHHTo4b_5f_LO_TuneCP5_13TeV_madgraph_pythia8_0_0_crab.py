...
config.JobType.pyCfgParams = ['isData=FALSE', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016postVFP', 'systematicVariations=nominal', 'weight=5.48E-08', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
