...
config.General.requestName = 'SingleElectronG_2016G_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016postVFP',
                              'systematicVariations=nominal', 'weight=6.52E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
