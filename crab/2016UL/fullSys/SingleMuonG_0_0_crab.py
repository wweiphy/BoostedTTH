...
config.General.requestName = 'SingleMuonG_2016G_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2016', 'systematicVariations=nominal', 'weight=6.67E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
