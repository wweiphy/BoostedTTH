...
config.General.requestName = 'TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_2016postVFP_ntuple_0_0_3'
...
config.JobType.pyCfgParams = ['isData=FALSE', 'maxEvents=99999999', 'outName=ntuples', 'dataEra=2016postVFP',
                              'systematicVariations=nominal,JES,JER', 'weight=8.37E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
