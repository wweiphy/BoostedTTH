...
config.General.requestName = 'TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_2016preVFP_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=FALSE', 'maxEvents=99999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal,JES,JER,JESFlavorQCD,JESRelativeBal,JESHF,JESBBEC1,JESEC2,JESAbsolute,JESBBEC1year,JESRelativeSampleyear,JESEC2year,JESHFyear,JESAbsoluteyear', 'weight=3.27E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
