...
config.General.requestName = 'SingleMuonC_2016APVC_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=1.48E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
