...
config.General.requestName = 'SingleMuonD_2016APVD_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=1.02E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
