...
config.General.requestName = 'SingleElectronD_2016APVD_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=6.75E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
