...
config.General.requestName = 'SingleMuonB_2016APVB1_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=3.59E-04', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
