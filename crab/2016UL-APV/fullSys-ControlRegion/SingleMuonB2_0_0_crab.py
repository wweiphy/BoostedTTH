...
config.General.requestName = 'SingleMuonB_2016APVB2_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=6.32E-06', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
