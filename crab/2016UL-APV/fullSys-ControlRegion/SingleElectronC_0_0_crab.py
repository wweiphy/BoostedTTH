...
config.General.requestName = 'SingleElectronC_2016APVC_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=1.03E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
