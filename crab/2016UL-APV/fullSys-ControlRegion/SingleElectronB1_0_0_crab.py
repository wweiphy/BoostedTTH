...
config.General.requestName = 'SingleElectronB_2016APVB1_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=7.03E-04', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
...
config.Data.inputDataset = '/SingleElectron/Run2016B-ver1_HIPM_UL2016_MiniAODv2-v2/MINIAOD'
...
config.Data.outputDatasetTag = 'sl_LEG_ntuple_2016APV'
config.Data.outLFNDirBase = '/store/group/lpctthrun2/wwei/UL/2016APV/ntuple'
