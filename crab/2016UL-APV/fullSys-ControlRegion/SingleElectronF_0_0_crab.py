...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016', 'systematicVariations=nominal','weight=1.62E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
