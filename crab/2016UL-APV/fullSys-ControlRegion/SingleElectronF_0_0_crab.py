...
config.General.requestName = 'SingleElectronF_2016APVF_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=1.62E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
