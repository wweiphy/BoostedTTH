...
config.General.requestName = 'SingleMuonE_2016APVE_ntuple_0_0'
...
config.JobType.pyCfgParams = ['isData=True', 'maxEvents=9999999999', 'outName=ntuples', 'dataEra=2016preVFP',
                              'systematicVariations=nominal', 'weight=1.10E-05', 'ProduceMemNtuples=False', 'deterministicSeeds=False']
